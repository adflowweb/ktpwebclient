...
ADF.PushStatsView = Backbone.View
		.extend({
					...
					if (searchDateEnd == null || searchDateEnd == "") {
						...
						if (searchDateStart >= searchDateEnd) {
							...
							return false;
								...
								&& inputMonthValue === searchDateStart
										.getMonth()) {
			...
			clickStatsSearch : function() {
				...
				if (this.clickStatsSearchFormCheck()) {
					var input_month_value = $('#msg-stats-month-date-input')
							.val();
					input_month_value = input_month_value.replace("/", "");

					var searchDateStart = $('#msg-stats-start-date-input')
							.val();
					var searchDateEnd = $('#msg-stats-end-date-input').val();
					var ajaxUrl = "";
					...
					if (searchDateStart != "") {
						...
						ajaxUrl = '/v1/pms/adm/svc/messages/summary/'
								...
								+ searchDateStart + "&cSearchDateEnd="
								+ searchDateEnd;
					} else {
								...
								for ( var i in data.result.data) {
									...
									if (successData.isReservation == false) {
										...
										case -2:
											...
											break;
										/*
										 * case -1: // dataResult[i].status =
										 * "허용갯수초과"; statusD1Cnt =
										 * successData.msgCnt; totalMsgCnt +=
										 ...
										 * case -1: // dataResult[i].status =
										 * "허용갯수초과"; statusRD1Cnt =
										 * successData.msgCnt; totalMsgCntR +=
										 * successData.msgCnt; break;
										 */
										case 0:
											// dataResult[i].status =
		...
		//					;
		//				});
				$.get('pages/js/template/push_stats_template.html', function(
						data) {
					var template = _.template(data, {});
					that.$el.html(template);
					
					var defaultMonth = $('#msg-stats-date-time-picker-div')
							.val();
